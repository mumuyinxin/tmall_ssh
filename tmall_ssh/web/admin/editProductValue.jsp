...
<script>
	$(function() {
		$("input.pvValue").keyup(function(){
			var value = $(this).val();
			var page = "editProductValue_Product.action";
...
<div class="workingArea">
	<ol class="breadcrumb">
	  ...
	  <li><a href="listProduct_Product.action?product.cid=${product.category.id}">${product.category.name}</a></li>
	  <li class="active">${product.name}</li>
	  <li class="active">编辑产品属性</li>
	</ol>

	<div class="editPVDiv">
		<c:forEach items="${product.propertyValues}" var="propertyValue">
			<div class="eachPV">
