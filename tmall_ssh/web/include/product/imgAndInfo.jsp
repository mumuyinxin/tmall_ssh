...
<script>
	$(function(){
		...
		$(".addCartLink").click(function(){
			var page = "frontCheckLogin_Front";
			$.get(
					page,
					function(result){
						if("success"==result){
							var pid = ${product.id};
							var num= $(".productNumberSetting").val();
							var addCartpage = "frontBuy_Front";
							$.get(
									addCartpage,
									{"product.id":pid,"num":num,"ajax":true},
									function(result){
										if("success"==result){
		...
		$("button.loginSubmitButton").click(function(){
			...
			$.get(
					page,
					{"user.name":name,"user.password":password,"ajax":true},
					function(result){
						if("success"==result){
							location.reload();
						}
...
<div class="imgAndInfo">
	...
	<div class="imgInimgAndInfo">
		<img src="img/productSingle/${product.firstImage.id}.jpg" class="bigImg">
	...
	<div class="infoInimgAndInfo">
		...
		<div class="productNumber">
			...
			<span>
				...
				<span class="arrow">
					<a href="#" onclick="return false" class="increaseNumber">
					<span class="updown">
					...
					<a href="#"  onclick="return false" class="decreaseNumber">
					<span class="updown">
		...
		<div class="buyDiv">
			<a class="buyLink" href="frontBuy_Front.action?product.id=${product.id}">
			...
			<%--<a href="frontCart_Front.action?product.id=${product.id}" class="addCartLink">--%>
				<%--<button class="addCartButton">--%>
					<%--<span class="glyphicon glyphicon-shopping-cart"></span>加入购物车--%>
				<%--</button>--%>
			<%--</a>--%>
