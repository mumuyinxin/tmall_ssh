...
<div class="buyPageDiv">
  <form action="frontPay_Front.action" method="post">
	<div class="buyFlow">
	...
	<div class="productList">
				...
				<c:forEach items="${orderItems}" var="oi" varStatus="st" >
					<tr class="orderItemTR">
						<td class="orderItemFirstTD">
							<img class="orderItemImg" src="img/productSingle_middle/${oi.product.firstImage.id}.jpg">
						</td>
						<td class="orderItemProductInfo">
							<a  href="frontProduct_Front.action?product.id=${oi.product.id}" class="orderItemProductLink">
								${oi.product.name}
							</a>
		...
		<div class="orderItemSumDiv">
			...
			<span class="pull-right">店铺合计(含运费): ￥<fmt:formatNumber type="number" value="${order.totalPrice}" minFractionDigits="2"/></span>
		</div>
	</div>
	...
	<div class="orderItemTotalSumDiv">
		<div class="pull-right"> 
			<span>实付款：</span>
			<span class="orderItemTotalSumSpan">￥<fmt:formatNumber type="number" value="${order.totalPrice}" minFractionDigits="2"/></span>
		</div>
	</div>
