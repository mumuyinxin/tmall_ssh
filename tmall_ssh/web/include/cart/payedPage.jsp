...
<div class="payedDiv">
	...
	<div class="payedAddressInfo">
		<ul>
			...
			<li>手机号码：${order.mobile }</li>
			<li>实付款：<span class="payedInfoPrice">
			￥<fmt:formatNumber type="number" value="${order.totalPrice}" minFractionDigits="2"/>
			</li>
			<li>预计08月08日送达	</li>
		</ul>
		...
		<div class="paedCheckLinkDiv">
			您可以
			<a class="payedCheckLink" href="frontBought_Front.action">查看已买到的宝贝</a>
			<a class="payedCheckLink" href="frontBought_Front.action">查看交易详情 </a>
		</div>
